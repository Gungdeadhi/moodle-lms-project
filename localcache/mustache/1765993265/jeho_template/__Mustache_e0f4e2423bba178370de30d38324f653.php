...
class __Mustache_e0f4e2423bba178370de30d38324f653 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionEc7faa4d79623a547a7bd21a175b46d0($context, $indent, $value);
        $value = $context->find('info');
        $buffer .= $this->sectionF6df578a07c4536b8af584a9cb0c6ac0($context, $indent, $value);
        $value = $context->find('cansignup');
        $buffer .= $this->sectionB9991204a960854872b225cee57a29ac($context, $indent, $value);
...
';
    ...
    private function sectionEc7faa4d79623a547a7bd21a175b46d0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionF6df578a07c4536b8af584a9cb0c6ac0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionB9991204a960854872b225cee57a29ac(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
