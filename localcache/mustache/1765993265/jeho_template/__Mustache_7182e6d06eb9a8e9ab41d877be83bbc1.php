...
class __Mustache_7182e6d06eb9a8e9ab41d877be83bbc1 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/drawer')) {
            $context->pushBlockContext(array(
                'tabindex' => array($this, 'block97cf4045effc9fee7c3d0e13d014f0be'),
                'role' => array($this, 'block8b2b56271b329fcb299a560c67215c3a'),
                'drawerattributes' => array($this, 'block2a139fddcacd30d7d022a5f230e81761'),
                'drawercontent' => array($this, 'block67d993187b94baa01ce6269c290690b8'),
            ));
...
';
    ...
    public function block97cf4045effc9fee7c3d0e13d014f0be($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . '-1';
    ...
    public function block8b2b56271b329fcb299a560c67215c3a($context)
    {
        $indent = $buffer = '';
        $buffer .= 'dialog';
    ...
    public function block2a139fddcacd30d7d022a5f230e81761($context)
    {
        $indent = $buffer = '';
        $buffer .= '        aria-modal="true"
';
        $buffer .= $indent . '        aria-labelledby="message-drawer-header-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '"
';
    ...
    public function block67d993187b94baa01ce6269c290690b8($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . '        <div id="message-drawer-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '" class="message-app" data-region="message-drawer" role="region" tabindex="0">
';
        $buffer .= $indent . '            <h2 class="visually-hidden" id="message-drawer-header-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '">';
