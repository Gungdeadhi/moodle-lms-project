...
class __Mustache_cddc95f9038c439d4a8d30005651c07a extends Mustache_Template
{
...
';
        $buffer .= $indent . '                            </div>
';
        $buffer .= $indent . '                            <div class="fp-tb-uploadfile">
';
        $buffer .= $indent . '                                <a title="';
        $value = $context->find('str');
        $buffer .= $this->sectionDb3cd1a78b08ae3456405b0a1cff1dfa($context, $indent, $value);
        $buffer .= '" class="btn btn-secondary btn-sm" href="#">
';
        $buffer .= $indent . '                                    ';
        $value = $context->find('pix');
        $buffer .= $this->section2c2ae59128f975022de4e7a179211f2a($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '                                </a>
';
...
';
    ...
    private function sectionDb3cd1a78b08ae3456405b0a1cff1dfa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section2c2ae59128f975022de4e7a179211f2a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
